...
while True:
    ...
    if (permission_trans=='y'):
        ...
        print ("\nSignature : " + signature)
        response = requests.get("http://127.0.0.1:5020/transactions/new", params={'sender_address': transaction_dict['sender_address'], 'recipient_address': transaction_dict['recipient_address'], 'value': transaction_dict['value'], 'signature': signature})
        print ()
